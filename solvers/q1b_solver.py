...
def q1b_solver(problem: q1b_problem):
    ...
    start_node = q1b_node(start_state, None, None, 0)
    ...
    while not frontier.isEmpty():
        ...
        for successor in problem.getSuccessors(node.get_state()):
            ...
            if successor[0].getPacmanPosition() not in explored:
                ...
                child_node = q1b_node(successor[0], node, successor[1], len(node.get_path())+1)
                ...
                # print(child_node.get_action(),child_node.get_cost(),min_manhattan,'COSTTTTTTT')
...
# def mst_heuristic(current_position, food_positions):
#     points = [current_position] + food_positions
#     total_cost = 0
#     visited = set()
#     priority_queue = [(0, current_position)]

#     while priority_queue:
#         cost, point = heapq.heappop(priority_queue)
...
#                     heapq.heappush(priority_queue, (util.manhattanDistance(point, other_point), other_point))
